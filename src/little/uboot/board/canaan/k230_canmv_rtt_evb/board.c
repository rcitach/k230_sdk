...
int ddr_init_training(void)
{
        ...
        #if defined(CONFIG_CANMV_DONGSHANPI_CORE_LPDDR3_2133)
                K230_dongshanpi_core_ddr_init_2133();
	#elif defined(CONFIG_CANMV_DONGSHANPI_CORE_LPDDR3_1866)
		K230_dongshanpi_core_ddr_init_1866();
	#elif defined(CONFIG_CANMV_DONGSHANPI_CORE_LPDDR4_2667)
		K230_dongshanpi_core_lpddr4_init_2677();
	#endif
